...
var AdminUser_RequiredField_Company = errors.New("Please provide a company for this admin user")

var AdminUser_InvalidAuthToken = errors.New("Invalid authentication token")
